...
export async function POST(req: NextRequest) {
  try {
    ...
    const { plan, email, firstName, lastName, restaurantName, zipCode,
            phone, address, restaurantType, offerTitle, offerDescription,
            offerType, adHeadline, adSubheadline, adTemplate, adColor } = body
    ...
    // Create subscription with incomplete status (requires payment method)
